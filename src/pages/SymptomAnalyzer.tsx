...
const SymptomAnalyzer = () => {
  const [messages, setMessages] = useState<Message[]>([
    {
      role: 'system',
      content: 'Welcome to the Symptom Analyzer. Please describe your symptoms in detail. Include your age, gender, and any relevant medical history to receive a better analysis.',
      timestamp: new Date(),
    },
  ]);
  ...
  const handleSendMessage = () => {
    ...
    // Start analyzing after user sends a message
  ...
  const sampleSymptoms = [
    ...
    "Sore throat", "Nasal congestion", "Chest pain"
  ];
            ...
            <div className="border-b">
              ...
              <div className="p-4">
                <div className="flex items-start gap-2">
                  <svg xmlns="http://www.w3.org/2000/svg" className="h-5 w-5 text-yellow-500 mt-1" viewBox="0 0 20 20" fill="currentColor">
